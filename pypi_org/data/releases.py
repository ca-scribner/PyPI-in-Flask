...
class Release(SqlAlchemyBase):
    ...
    # Connection to Package obj/table.  Can this be named anything?  And we don't need to invoke it somehow?
    # This might be missing a back_populates='releases' in the relation...
